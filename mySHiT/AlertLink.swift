...
class AlertLink : DeepLink {
    ...
    func handle() {
        if let tripElementId = userInfo[Constant.notificationUserInfo.tripElementId] as? Int {
        ...
        } else if let tripId = userInfo[Constant.notificationUserInfo.tripId] as? Int {
